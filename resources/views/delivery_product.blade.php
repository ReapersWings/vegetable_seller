...
@section('content')
    ...
    @endphp
    <h1 style="text-align: center"><ins>Data vegetable you buy</ins></h1>
    <a href="{{ route('product_data',$row->product_id) }}"><button style="width:46%;float:left;padding:25px">
        <h2 class="text"><b><ins>Data Vegetable:</ins></b></h1>
    ...
    <div style="width: 46%;float:right;padding:25px">
        <h2 class="data"><b><ins>Data vegetable for you:</ins></b></h2>
